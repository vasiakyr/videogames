//όταν ο παικτης πεφτει πανω στον enemy1 εμφανιζεται μηνυμα στην κοσολα οτι εχασε
...
public class EnemyMovement : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.CompareTag("Player"))
        {
            ...
            // Εδώ μπορείς να προσθέσεις οποιαδήποτε ενέργεια όταν ο παίκτης χάνει (π.χ., να τον επαναφέρεις στην αρχή της σκηνής)
            // Για παράδειγμα, να τερματίσει το παιχνίδι:
            // Application.Quit(); 
            // Ή να επαναφορτώσεις τη σκηνή:
