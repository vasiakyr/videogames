//για να κινείται δεξιά κ αριστερά η κινούμενη πλατφόρμα που βρίσκεται πάνω απο τον παίκτη
...
public class MovingPlatform : MonoBehaviour
{
    ...
    void OnDrawGizmos() //στον editor ζωγραφίζει γραμμή που ουσιαστικά δείχνει απο που μέχρι που κινείται το moving platform
    {
